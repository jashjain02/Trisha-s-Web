  ...
  return (
    ...
    >
      <div className="mx-auto px-4 md:px-6 py-3">
        ...
        >
          <Link to="/dashboard" className="flex items-center gap-2 group" aria-label="Trisha's Friendship Vault Home">
            <motion.span
              className="text-xl"
            ...
            <span className="font-bold text-white text-sm hidden sm:block tracking-tight">
              Trisha's Friendship Vault<span className="text-[#FF2E93] align-super text-[10px]">™</span>
            </span>
          </Link>
